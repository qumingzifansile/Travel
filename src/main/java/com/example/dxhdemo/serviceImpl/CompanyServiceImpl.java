...
public class CompanyServiceImpl implements com.example.dxhdemo.service.CompanyService {
    ...
    @Override
    public void publine(long companyid,String tno,String xlname,String tj,String dengji,String xltype,
                        long ts, long zrs, String dijie,String qp,String dp,String start,String jzd,String sz,String fc,
                        ...
                        String status,String tp1js,String tp2js, String xgxl, String views,String weblog,double icrjg,
                        double ixhjg,long state) {
        ...
        travelviewMapperGB.pubTravelview(companyid, tno, xlname, dengji, xltype, ts, xcap, xcbz, xcsm);
        ...
        for (String s:splitviews) {
            ...
            if (lineviewMapperGB.searchbytnoandviews(tno,s)==null){
                lineviewMapperGB.addLineview(tno,s);
            }
        }
    }
    ...
    @Override
    public void updateline(long companyid,String tno,String xlname,String tj,String dengji,String xltype,String xldate,
                           long ts, long zrs, String dijie,String qp,String dp,String start,String jzd,String sz,
                           String fc, String jz, String cfd, String ddd,String crxrs,String xhxrs,String xingchen,
                           String xcap, String xcbz, String xcsm,String lxfs, String bak,long Travel_bh,
                           String Travel_name, String status, String tp1js, String tp2js,String xgxl, String views,
                           String weblog, double icrjg,double ixhjg,long state) {
