...
public interface LineServiceGB {
    void addline(String tno,String xlname,String tj,String dengji,String xltype,long ts,long zrs,
                 ...
                 String views,String weblog,double icrjg,double ixhjg,long state);                                      //新增线路信息
    void updateline(String tno,String xlname,String tj,String dengji,String xltype,String xldate,long ts,
                    ...
                    String tp2js,String xgxl, String views,String weblog,double icrjg,double ixhjg,long state);         //修改线路信息
